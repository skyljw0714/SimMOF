...
CoREMOF_2024_abspath = Path("/home/users/taeun8991/cif_collector/CSD-modified/CR_data_CSD_modified_20250227.csv")
...
class MOFStructure:
    ...
    def get_refcode(self):
        ...
        print('### Find REFCODE ... ###')
        self.refcode = None
        refcode = self._get_refcode_from_name(self.name)  #if name is refcode
        if refcode:
        ...
        refcode = self._get_refcode_from_synonym(self.name) #if name is synonym of refcode
        if refcode:
        ...
        refcode = self._get_refcode_from_doi(self.doi) if self.doi else None #if doi is uploaded on CSD
        if refcode:
...
PHASE_DIRS = {
    "ASR": Path("/home/users/taeun8991/cif_collector/CSD-modified/cifs/CR/ASR"),
    "FSR": Path("/home/users/taeun8991/cif_collector/CSD-modified/cifs/CR/FSR"),
    "Ion": Path("/home/users/taeun8991/cif_collector/CSD-modified/cifs/CR/Ion"),
}
...
def is_exact_match(name, keyword):
    ...
    #print(normalized_name, normalized_keyword)
